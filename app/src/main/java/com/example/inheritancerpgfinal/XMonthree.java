...
public class XMonthree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_x_monthree);
        ...
        threemonpic = findViewById(R.id.Monthreeim);
